...
import com.example.bncmovieapp.databinding.FragmentFavoriteBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            movieAdapter.onItemClick = { selectedMovie ->
                ...
                MovieActivity.MOVIE_ID = selectedMovie
            ...
            movieAdapter.onHeartClick = { selectedMovie ->
                favoriteViewModel.setFavoriteMovie(selectedMovie, !selectedMovie.isFavorite)
            }
