package com.example.bncmovieapp.core.di

import androidx.room.Room
import com.example.bncmovieapp.core.data.MovieRepository
import com.example.bncmovieapp.core.data.source.local.LocalDataSource
import com.example.bncmovieapp.core.data.source.local.room.MovieDatabase
...
val networkModule = module {
    ...
    single {
        val retrofit = Retrofit.Builder()
            .baseUrl("https://private-anon-1a23ad70a1-bncfetest.apiary-mock.com/")
